...
let trackList = [
    {
        name: "Die For You",
        artist: "The Weeknd",
        path: "./music/The Weeknd - Die For You (Sub. Español)_SvizVoNjv7A.mp3",
    },
    {
        name: "Die With A Smile",
        artist: "Lady Gaga-Bruno Mars",
        path: "./music/Lady Gaga, Bruno Mars - Die With A Smile (Official Music Video)_kPa7bsKwL-c.mp3",
    },
    {
        name: "SSFW",
        artist: "CHANYEOL",
        path: "./music/CHANYEOL (EXO) - SSFW_ traducción al español_nv4ueCSDjjE.mp3",
    },
    {
        name: "Loco Por Volverla A Ver",
        artist: "Las Pastillas Del Abuelo",
        path: "./music/Loco por volverla a ver - Las Pastillas Del Abuelo (Letra)_lAgaixPTyQI.mp3",
    },
];
